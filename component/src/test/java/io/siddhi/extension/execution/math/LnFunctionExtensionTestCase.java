...
public class LnFunctionExtensionTestCase {
    ...
    private static Logger logger = LogManager.getLogger(LnFunctionExtensionTestCase.class);
        ...
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
            ...
            public void receive(long timeStamp, Event[] inEvents,
                ...
                for (Event event : inEvents) {
                    ...
                    AssertJUnit.assertEquals((Double) 2.438251704415579, result);
                }
            }
        });
    ...
    public void testProcessInteger() throws Exception {
        ...
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
            ...
            public void receive(long timeStamp, Event[] inEvents,
                ...
                for (Event event : inEvents) {
                    result = (Double) event.getData(0);
                    AssertJUnit.assertEquals((Double) 2.3978952727983707, result);
                }
            }
        });
        InputHandler inputHandler = siddhiAppRuntime
    ...
    public void testProcessLong() throws Exception {
        ...
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
            ...
            public void receive(long timeStamp, Event[] inEvents,
                ...
                for (Event event : inEvents) {
                    result = (Double) event.getData(0);
                    AssertJUnit.assertEquals((Double) 13.931907744886864, result);
                }
            }
        });
        InputHandler inputHandler = siddhiAppRuntime
    ...
    public void testProcessFloat() throws Exception {
        ...
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
            ...
            public void receive(long timeStamp, Event[] inEvents,
                ...
                for (Event event : inEvents) {
                    result = (Double) event.getData(0);
                    AssertJUnit.assertEquals((Double) 4.721567374105912, result);
                }
            }
        });
        InputHandler inputHandler = siddhiAppRuntime
