...
public class CoshFunctionExtensionTestCase {
    ...
    private static Logger logger = LogManager.getLogger(CoshFunctionExtensionTestCase.class);
        ...
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
            ...
            public void receive(long timeStamp, Event[] inEvents,
                ...
                for (Event event : inEvents) {
                    ...
                    AssertJUnit.assertEquals((Double) 201.7156361224559, result);
                }
            }
        });
    ...
    public void testProcessLong() throws Exception {
        ...
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
            ...
            public void receive(long timeStamp, Event[] inEvents,
                ...
                for (Event event : inEvents) {
                    result = (Double) event.getData(0);
                    AssertJUnit.assertEquals((Double) 8.919117146583567E278, result);
                }
            }
        });
        InputHandler inputHandler = siddhiAppRuntime
    ...
    public void testProcessFloat() throws Exception {
        ...
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
            ...
            public void receive(long timeStamp, Event[] inEvents,
                ...
                for (Event event : inEvents) {
                    result = (Double) event.getData(0);
                    AssertJUnit.assertEquals((Double) 4.818179646120534E27, result);
                }
            }
        });
        InputHandler inputHandler = siddhiAppRuntime
