...
public class Log2FunctionExtensionTestCase {
    ...
    private static Logger logger = LogManager.getLogger(Log2FunctionExtensionTestCase.class);
    ...
    public void testProcess() throws Exception {
        ...
        SiddhiAppRuntime siddhiAppRuntime = siddhiManager
                .createSiddhiAppRuntime(inValueStream + eventFuseExecutionPlan);
        ...
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
            ...
            public void receive(long timeStamp, Event[] inEvents,
                ...
                for (Event event : inEvents) {
                    ...
                    AssertJUnit.assertEquals((Double) 6.507794640198696, result);
                }
            }
        });
    ...
    public void testProcessLong() throws Exception {
        ...
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
            ...
            public void receive(long timeStamp, Event[] inEvents,
                ...
                for (Event event : inEvents) {
                    result = (Double) event.getData(0);
                    AssertJUnit.assertEquals((Double) 23.138560860771687, result);
                }
            }
        });
        InputHandler inputHandler = siddhiAppRuntime
    ...
    public void testProcessFloat() throws Exception {
        ...
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
            ...
            public void receive(long timeStamp, Event[] inEvents,
                ...
                for (Event event : inEvents) {
                    result = (Double) event.getData(0);
                    AssertJUnit.assertEquals((Double) 9.85084848259538, result);
                }
            }
        });
        InputHandler inputHandler = siddhiAppRuntime
