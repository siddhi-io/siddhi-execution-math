...
public class SinhFunctionExtensionTestCase {
    ...
    private static Logger logger = LogManager.getLogger(SinhFunctionExtensionTestCase.class);
        ...
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
            ...
            public void receive(long timeStamp, Event[] inEvents,
                ...
                for (Event event : inEvents) {
                    ...
                    AssertJUnit.assertEquals((Double) (201.71315737027922), result);
                }
            }
        });
    ...
    public void testProcessLong() throws Exception {
        ...
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
            ...
            public void receive(long timeStamp, Event[] inEvents,
                ...
                for (Event event : inEvents) {
                    result = (Double) event.getData(0);
                    AssertJUnit.assertEquals((Double) (1.8383670615634575E270), result);
                }
            }
        });
        InputHandler inputHandler = siddhiAppRuntime
    ...
    public void testProcessFloat() throws Exception {
        ...
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
            ...
            public void receive(long timeStamp, Event[] inEvents,
                ...
                for (Event event : inEvents) {
                    result = (Double) event.getData(0);
                    AssertJUnit.assertEquals((Double) (2.5879283518955854E270), result);
                }
            }
        });
        InputHandler inputHandler = siddhiAppRuntime
