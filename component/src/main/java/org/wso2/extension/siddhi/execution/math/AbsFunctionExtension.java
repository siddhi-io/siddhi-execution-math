...
public class AbsFunctionExtension extends FunctionExecutor {
    ...
    protected void init(ExpressionExecutor[] attributeExpressionExecutors, ExecutionPlanContext executionPlanContext) {
        if (attributeExpressionExecutors.length != 1) {
            throw new ExecutionPlanValidationException("Invalid no of arguments passed to math:abs() function, " +
        ...
        if (!((attributeType == Attribute.Type.DOUBLE)
            ...
            throw new ExecutionPlanValidationException("Invalid parameter type found for the argument of math:abs() function, " +
    ...
    protected Object execute(Object data) {
        if (data != null) {
            ...
            throw new ExecutionPlanRuntimeException("Input to the math:abs() function cannot be null");
        }
        return null;
    }
